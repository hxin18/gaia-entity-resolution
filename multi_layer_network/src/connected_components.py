...
def main(argv):
    ...
    for opt, arg in opts:
        if opt == '-h':
            print('Given an edge list, outputs the connected components, usage: python connected_components.py -e <edgelist> -o <outputfile>')
            sys.exit()
        elif opt in ("-e", "--efile"):
            edgelist = arg
        elif opt in ("-o", "--ofile"):
    ...
    edgelist = "../data_out/RPI_clusters_seedling_same_link_with_nil.edgelist"
    outputfile = "../data_out/RPI_clusters_seedling_same_link_clusters_with_nil.jl"
